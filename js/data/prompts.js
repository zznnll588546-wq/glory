...
channel_scoping:
  - 系统会注入「当前对话窗口」锚定（与用户私聊 / 用户所在群聊 / 旁观或无用户在场群聊等），并对「上下文记忆」按来源会话分块标注
  - 严格遵守：不要把某一私聊里的话当成群里人人都知道；不要把旁观群聊写成用户正在该窗口打字，除非记录里确有用户消息
  - 引用非当前会话的记忆时须有合理获知路径，禁止无依据全知
...
inner_monologue:
  ...
  weibo_forum: {
    ...
    category: 'social',
    content: `[微博/论坛角色扮演预设]
目标：像真实中文互联网社区，而不是同质化模板文案。

微博侧要求：
- 热搜话题统一使用 #话题# 包裹
- 可混合：赛程相关、生活分享、猫狗美食、营销号搬运、辟谣、抽奖、追星看球、番剧游戏讨论
- 允许“知情人爆料/路人抓拍/吃瓜转述”叙事，但不要直接泄露私聊原文
- 评论区要有不同阵营（粉黑大战、控评、路人、乐子人），避免全员同立场
- 角色发言必须符合人设与赛季身份，不要人人一个口吻

论坛侧要求：
- 帖子类型应混合：战术分析、赛后复盘、爆料传闻、吵架互喷、反黑澄清
- 药庙之争、霸图嘉世宿怨等可出现，但不要每帖强行套同一冲突
- 数据帖可引用“看起来真实”的数字与比赛细节，增强可信度
